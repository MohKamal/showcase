		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				...
				@if(\Showcase\Framework\HTTP\Gards\Auth::guest()){
					...
					display('<li class="nav-item"><a class="nav-link disabled" href="#">' . display(\Showcase\Framework\HTTP\Gards\Auth::user() == null ? '' : \Showcase\Framework\HTTP\Gards\Auth::user()->email) . '</a></li>');
